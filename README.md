...
*Customizable grid layout - click any cell to add a component*
...
- **Persistent Layout** - Your layout configuration is saved
...
- **`pnpm test`** - Launch the test runner in interactive watch mode
- **`pnpm build`** - Build the app for production to the `build` folder
- **`pnpm eject`** - Eject from Create React App (one-way operation, use with caution)

## 🛠️ Built With

- [React](https://reactjs.org/) - UI framework
- [Create React App](https://github.com/facebook/create-react-app) - Build tooling
- [D&D 5e API](https://www.dnd5eapi.co/) - D&D rules data
